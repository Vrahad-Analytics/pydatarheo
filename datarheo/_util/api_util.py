...
directly. This will ensure a single source of truth when mapping between the `datarheo` and
...
def _validate_pagination_params(
    *,
    ...
    if limit is not None and limit <= 0:
        raise DataRheoInputError(message="`limit` must be greater than 0.")
...
def get_config_api_root(
    ...
    *,
    ...
    2. If `DATARHEO_CLOUD_CONFIG_API_URL` environment variable is set, use that value.
...
def get_datarheo_server_instance(
    *,
    api_root: str,
    ...
    Raises:
        DataRheoInputError: If authentication parameters are invalid.
    """
...
def get_workspace(
    ...
    *,
    ...
    datarheo_instance = get_datarheo_server_instance(
        api_root=api_root,
        client_id=client_id,
        client_secret=client_secret,
    ...
    try:
        response = datarheo_instance.workspaces.get_workspace(
    ...
    raise DataRheoMissingResourceError(
...
def create_workspace(
    *,
    ...
    try:
        response = datarheo_instance.workspaces.create_workspace(
...
def rename_workspace(
    ...
    *,
    ...
    try:
        response = datarheo_instance.workspaces.update_workspace(
...
def permanently_delete_workspace(
    ...
    *,
    ...
    Raises:
        DataRheoInputError: If safe mode is True and the workspace name does not meet
            the safety requirements.
        DataRheoWorkspaceNotEmptyError: If the workspace contains connections.
    """
    if safe_mode:
    ...
    if connections:
        raise DataRheoWorkspaceNotEmptyError(
            workspace_id=workspace_id,
    ...
    try:
        response = datarheo_instance.workspaces.delete_workspace(
...
def list_connections(
    ...
    *,
    ...
    if name is not None and name_filter:
        raise DataRheoInputError(message="You can provide name or name_filter, but not both.")
    ...
    while remaining is None or remaining > 0:
        try:
            response = datarheo_instance.connections.list_connections(
...
def list_workspaces(
    ...
    *,
    ...
    datarheo_instance: airbyte_api.AirbyteAPI = get_datarheo_server_instance(
        client_id=client_id,
        client_secret=client_secret,
        bearer_token=bearer_token,
        api_root=api_root,
    ...
    while remaining is None or remaining > 0:
        ...
        try:
            response: api.ListWorkspacesResponse = datarheo_instance.workspaces.list_workspaces(
...
def list_sources(
    ...
    *,
    ...
    while remaining is None or remaining > 0:
        try:
            response: api.ListSourcesResponse = datarheo_instance.sources.list_sources(
...
def list_destinations(
    ...
    *,
    ...
    while remaining is None or remaining > 0:
        try:
            response = datarheo_instance.destinations.list_destinations(
...
def get_connection(
    ...
    *,
    ...
    try:
        response = datarheo_instance.connections.get_connection(
...
def run_connection(
    ...
    *,
    ...
    response = datarheo_instance.jobs.create_job(
    ...
    raise DataRheoConnectionSyncError(
        connection_id=connection_id,
        context={
            "workspace_id": workspace_id,
            "request_url": response.raw_response.url,
...
def get_job_logs(  # noqa: PLR0913  # Too many arguments - needed for auth flexibility
    ...
    *,
    ...
    while remaining is None or remaining > 0:
        ...
        try:
            response: api.ListJobsResponse = datarheo_instance.jobs.list_jobs(
                api.ListJobsRequest(
                    workspace_ids=[workspace_id],
                    connection_id=connection_id,
                    limit=page_limit,
...
def get_job_info(
    ...
    *,
    ...
    response = datarheo_instance.jobs.get_job(
        api.GetJobRequest(
            job_id=job_id,
        ),
    )
...
def cancel_job(
    ...
    *,
    ...
    response = datarheo_instance.jobs.cancel_job(
...
def create_source(
    ...
    *,
    ...
    response: api.CreateSourceResponse = datarheo_instance.sources.create_source(
...
def get_source(
    ...
    *,
    ...
    response = datarheo_instance.sources.get_source(
...
def delete_source(
    ...
    *,
    ...
    Raises:
        DataRheoInputError: If safe_mode is True and the source name does not meet
            the safety requirements.
    """
    _ = workspace_id  # Not used (yet)
    ...
    response = datarheo_instance.sources.delete_source(
...
def patch_source(
    ...
    *,
    ...
    response = datarheo_instance.sources.patch_source(
...
def get_destination(
    ...
    *,
    ...
    response = datarheo_instance.destinations.get_destination(
...
def delete_destination(
    ...
    *,
    ...
    Raises:
        DataRheoInputError: If safe_mode is True and the destination name does not meet
            the safety requirements.
    """
    _ = workspace_id  # Not used (yet)
    ...
    response = datarheo_instance.destinations.delete_destination(
...
def patch_destination(
    ...
    *,
    ...
    response = datarheo_instance.destinations.patch_destination(
...
def create_connection(  # noqa: PLR0913  # Too many arguments
    ...
    *,
    ...
    response = datarheo_instance.connections.create_connection(
...
def get_connection_by_name(
    ...
    *,
    ...
    if len(found) > 1:
        raise DataRheoMultipleResourcesError(
            resource_type="connection",
...
def delete_connection(
    ...
    *,
    ...
    Raises:
        DataRheoInputError: If safe_mode is True and the connection name does not meet
            the safety requirements.
    """
    if safe_mode:
    ...
    response = datarheo_instance.connections.delete_connection(
...
def patch_connection(  # noqa: PLR0913  # Too many arguments
    ...
    *,
    ...
    response = datarheo_instance.connections.patch_connection(
...
def validate_yaml_manifest(
    ...
    *,
    ...
    if not isinstance(manifest, dict):
        ...
        if raise_on_error:
            raise DataRheoInputError(message=error, context={"manifest": manifest})
        return False, error
...
def list_custom_yaml_source_definitions(
    ...
    *,
    ...
    response = datarheo_instance.declarative_source_definitions.list_declarative_source_definitions(
        request
    )
    if (
...
def get_custom_yaml_source_definition(
    ...
    *,
    ...
    response = datarheo_instance.declarative_source_definitions.get_declarative_source_definition(
        request
    )
    if (
        not status_ok(response.status_code)
...
def delete_custom_yaml_source_definition(
    ...
    *,
    ...
    Raises:
        DataRheoInputError: If safe_mode is True and the connector name does not meet
            the safety requirements.
    """
    if safe_mode:
...
def list_organizations_for_user(
    *,
    ...
    response = datarheo_instance.organizations.list_organizations_for_user()
...
def replace_connection_state(
    ...
    *,
    ...
    except DataRheoCloudError as ex:
        if ex.context and ex.context.get("status_code") == HTTPStatus.LOCKED:
            raise DataRheoConnectionSyncActiveError(
