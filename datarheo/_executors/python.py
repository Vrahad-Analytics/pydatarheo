...
from datarheo._util.telemetry import EventState, log_install_state
...
class VenvExecutor(Executor):
    def __init__(
        ...
        *,
        ...
        if not pip_url and metadata and not metadata.pypi_package_name:
            raise exc.DataRheoConnectorNotPyPiPublishedError(
    ...
    def install(self) -> None:
        ...
        try:
            ...
            with suppress(exc.DataRheoSubprocessFailedError):
                self.uninstall()

            raise exc.DataRheoConnectorInstallationError from ex
        ...
        *,
        ...
        try:
            package_name = (
                ...
                else f"datarheo-{connector_name}"
            )
