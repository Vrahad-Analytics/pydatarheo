...
def _stream_from_subprocess(
    ...
    *,
    ...
    if process.stdout is None:
        raise exc.DataRheoSubprocessError(
    ...
    try:
        ...
        try:
            ...
            # If the exit code is not 0 or -15 (SIGTERM), raise DataRheoSubprocessFailedError.
    ...
    def __init__(
        ...
        *,
        ...
        if not name and not metadata:
            raise exc.DataRheoInternalError(message="Either name or metadata must be provided.")
