...
"""Base classes and methods for working with secrets in PyDataRheo."""
...
class SecretSourceEnum(str, Enum):
    """Enumeration of secret sources supported by PyDataRheo."""
...
class SecretManager(ABC):
    ...
    By registering a secret manager, PyDataRheo can automatically locate and
...
class SecretHandle:
    ...
    def parse_json(self) -> dict:
        ...
        string, a `DataRheoInputError` will be raised.
        """
