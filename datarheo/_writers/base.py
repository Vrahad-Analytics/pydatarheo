...
"""Write interfaces for PyDataRheo."""
...
class AirbyteWriterInterface(abc.ABC):
    ...
    def _write_datarheo_io_stream(
        ...
        *,
        ...
        This is a specialized version of `_write_datarheo_message_stream` that reads from an IO
    ...
    def _write_datarheo_message_stream(
        ...
        *,
        ...
        Note: Callers should use `_write_datarheo_io_stream` instead of this method if
