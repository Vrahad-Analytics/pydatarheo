...
"""Callbacks for working with PyDataRheo."""
...
This callback can be passed to supporting functions like `datarheo.get_source()` and
`datarheo.get_destination()` to take action whenever configuration changes.
...
For more information on the underlying connector protocol, please see documentation on the
