...
from datarheo.exceptions import DataRheoSecretNotFoundError
...
def duckdb_destination_to_cache(
    ...
    if db_path.startswith(("/local/", "/local\\")):
        from datarheo.constants import DEFAULT_PROJECT_DIR  # noqa: PLC0415
    ...
    if (
        ...
        if "****" in destination_password:
            try:
                ...
                raise DataRheoSecretNotFoundError(
