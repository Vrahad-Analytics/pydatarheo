...
CACHE_STATE_TABLE_NAME = "_datarheo_state"
DESTINATION_STATE_TABLE_NAME = "_datarheo_destination_state"
        ...
        *,
        ...
        Args:
            ...
            destination_name: The name of the destination, if writing to a destination. Otherwise,
                this should be `None` to write state for the PyDataRheo cache itself.
        """
