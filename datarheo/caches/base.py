...
from datarheo.datasets._sql import CachedDataset
...
if TYPE_CHECKING:
    ...
    from datarheo.caches._state_backend_base import StateBackendBase
...
class CacheBase(SqlConfig, DatarheoWriterInterface):  # noqa: PLR0904
    ...
    def _write_datarheo_message_stream(
        ...
        *,
        ...
        cache_processor.process_datarheo_messages(
