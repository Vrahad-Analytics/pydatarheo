...
from datarheo.secrets.hydration import deep_update, detect_hardcoded_secrets
...
def resolve_connector_config(  # noqa: PLR0912
    ...
    (`datarheo.mcp._guards.raise_if_untrusted_execution_context`): reading a local `config_file`,
