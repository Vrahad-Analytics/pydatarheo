...
from datarheo.mcp.interactive._shared_models import (
    ConnectorType,
...
def show_connectors_list(
    ...
    return ToolResult(
        ...
        meta={"datarheo_mcp_raw_result": _jsonable(agent_value)},
    )
...
def _connector_metadata_to_public_summary(
    ...
    return PublicConnectorSummary(
        ...
        docker_repository=connector.docker_repository or f"datarheo/{connector.name}",
