...
- `DATARHEO_MCP_AUTH_ALLOW_CLIENT_CREDENTIALS`: enables the opt-in path.
- `DATARHEO_MCP_AUTH_CLIENT_CREDENTIALS_TOKEN_URL`: overrides the Airbyte Cloud
...
ALLOW_CLIENT_CREDENTIALS_ENV = "DATARHEO_MCP_AUTH_ALLOW_CLIENT_CREDENTIALS"
...
TOKEN_URL_ENV = "DATARHEO_MCP_AUTH_CLIENT_CREDENTIALS_TOKEN_URL"
DATARHEO_CLOUD_TOKEN_URL = "https://api.airbyte.com/v1/applications/token"
...
def _token_url() -> str:
    ...
    """
    return os.getenv(TOKEN_URL_ENV, "").strip() or DATARHEO_CLOUD_TOKEN_URL
