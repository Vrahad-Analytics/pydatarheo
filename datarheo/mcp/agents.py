...
from datarheo.mcp._arg_resolvers import resolve_list_of_strings
from datarheo.mcp._tool_utils import DATARHEO_CLOUD_WORKSPACE_ID_IS_SET
...
stream rather than JSON, which PyDataRheo does not yet support.
"""
...
def _agents_access_message(error: DataRheoCloudError) -> str | None:
    ...
    api_args: Annotated[
        ...
        Field(
            description=(
                ...
                "object string. For example {'repository': 'Vrahad-Analytics/pydatarheo'}."
            ),
            default=None,
        ),
    ],
