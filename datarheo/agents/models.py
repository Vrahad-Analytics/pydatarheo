...
payloads that PyDataRheo deliberately does not attempt to model exhaustively.
"""
...
class AgentExecuteResult(BaseModel):
    ...
    def entities(self) -> list[dict[str, Any]]:
        ...
        Raises `DataRheoInputError` if the action did not return a list of entities. Use
