...
from datarheo._util.api_util import get_bearer_token, status_ok
...
def check_public_cloud_api_roots(credentials: _AirbyteCredentials) -> None:
    """Raise `DataRheoInputError` unless the credentials use the public Cloud API roots.
    ...
    *,
    ...
    if "json" not in content_type:
        raise DataRheoCloudError(
            ...
            guidance=(
                "PyDataRheo does not yet support streaming responses, which some actions "
