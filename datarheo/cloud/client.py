...
class CloudClient:
    ...
    def list_workspaces(  # noqa: PLR0911, PLR0913
        ...
        *,
        ...
        if limit is not None and limit <= 0:
            raise exc.DataRheoInputError(message="`limit` must be greater than 0.")
        ...
        raise exc.DataRheoInputError(message="Unsupported workspace privilege scope.")
    ...
    def _resolve_ambient_organization_id(self) -> str | None:
        ...
        if self.default_workspace_id is not None:
            ...
            except (exc.DataRheoCloudError, exc.DataRheoInputError):
                pass
    ...
    def resolve_default_workspace_id(self) -> str | None:
        ...
        except (DataRheoCloudError, exc.DataRheoInputError):
            return None
    ...
    def _get_direct_workspace_info(self, workspace_id: str) -> CloudWorkspaceInfo | None:
        ...
        except exc.DataRheoMissingResourceError:
