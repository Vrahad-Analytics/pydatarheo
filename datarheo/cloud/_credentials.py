...
WORKSPACE_ID_ENV_VAR = "DATARHEO_WORKSPACE_ID"
ORGANIZATION_ID_ENV_VAR = "DATARHEO_ORGANIZATION_ID"
BEARER_TOKEN_ENV_VAR = "DATARHEO_BEARER_TOKEN"
    ...
    def from_auth(
        ...
        *,
        ...
        if not resolved_bearer_token and not resolved_client_id:
            raise DataRheoNoCloudCredentialsError(_env_vars=env_vars)
