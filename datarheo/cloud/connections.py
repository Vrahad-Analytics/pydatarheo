...
from datarheo.cloud._connection_catalog import (
...
from datarheo.cloud.constants import FINAL_STATUSES
...
class CloudConnection:  # noqa: PLR0904  # Too many public methods
    ...
    def _fetch_connection_info(
        ...
        *,
        ...
        Raises:
            DataRheoWorkspaceMismatchError: If verify is True and the connection's
                workspace_id doesn't match the expected workspace.
            DataRheoMissingResourceError: If the connection doesn't exist.
        """
    ...
    def _verify_workspace_match(self, connection_info: CloudConnectionInfo) -> None:
        ...
        Raises:
            DataRheoWorkspaceMismatchError: If the workspace IDs don't match.
        """
        if connection_info.workspace_id != self.workspace.workspace_id:
            raise DataRheoWorkspaceMismatchError(
    ...
    def check_is_valid(self) -> bool:
        ...
        Raises:
            DataRheoWorkspaceMismatchError: If the connection belongs to a different workspace.
            DataRheoMissingResourceError: If the connection doesn't exist.
        """
    ...
    def import_raw_state(
        ...
        Raises:
            DataRheoConnectionSyncActiveError: If a sync is currently running on this
    ...
    def set_stream_state(
        ...
        Raises:
            DataRheoInputError: If the connection state type is not supported for
