...
source = dr.get_source("source-faker", config={"count": 100})
...
from datarheo._util.api_util import get_web_url_root
...
from datarheo.cloud.connectors import (
    CloudDestination,
    CloudSource,
    CustomCloudSourceDefinition,
)
from datarheo.cloud.models import CloudWorkspaceInfo
...
class CloudWorkspace:
    ...
    def from_env(
        ...
        *,
        ...
        Raises:
            DataRheoInputError: If required credentials are not found in
    ...
    def get_organization(
        ...
        *,
        ...
        Raises:
            DataRheoCloudError: If raise_on_error=True and the organization info cannot be fetched
                (e.g., due to insufficient permissions or missing data).
        """
        try:
            info = self._organization_info
        except (DataRheoCloudError, NotImplementedError):
            if raise_on_error:
                raise
            return None
    ...
    def deploy_source(
        ...
        *,
        ...
        if unique:
            ...
            if existing:
                raise exc.DataRheoDuplicateResourcesError(
    ...
    def permanently_delete(
        ...
        *,
        ...
        and raises `DataRheoWorkspaceNotEmptyError` if the workspace is not empty.
        """
    ...
    def publish_custom_source_definition(
        ...
        *,
        ...
        Raises:
            DataRheoInputError: If both or neither of manifest_yaml and docker_image provided
            DataRheoDuplicateResourcesError: If unique=True and name already exists
        """
