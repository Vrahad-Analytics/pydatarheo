...
`datarheo.cloud.workspaces` module to create and manage cloud connector objects.
...
class CustomCloudSourceDefinition:
    ...
    def get_builder_project_data(
        ...
        *,
        ...
        Raises:
            ...
            DataRheoInputError: If the connector builder project ID cannot be found.
        """
        if self.definition_type != "yaml":
            raise NotImplementedError(
    ...
    def update_definition(
        ...
        *,
        ...
        Raises:
            DataRheoInputError: If both or neither parameters are provided
    ...
    def rename(
        ...
        Raises:
            DataRheoInputError: If attempting to rename a YAML connector
