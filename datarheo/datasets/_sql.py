...
class SQLDataset(DatasetBase):
    ...
    def column_names(self) -> list[str]:
        """Return the list of top-level column names, including internal DataRheo columns."""
        return [*super().column_names, DR_RAW_ID_COLUMN, DR_EXTRACTED_AT_COLUMN, DR_META_COLUMN]
