...
For usage examples, see the `datarheo.destinations` module documentation.
"""
...
from datarheo.shared.state_providers import (
    JoinedStateProvider,
    StateProviderBase,
    StaticInputState,
)
from datarheo.shared.state_writers import NoOpStateWriter, StdOutStateWriter
...
class Destination(ConnectorBase, AirbyteWriterInterface):
    ...
    def get_sql_cache(
        ...
        *,
        ...
        `SyncResult.get_sql_cache()` in `datarheo.cloud.sync_results`:
        ...
        *,
        ...
        if source:
            if cache is False:
                ...
                message_iterator: AirbyteMessageIterator = source._get_datarheo_message_iterator(  # noqa: SLF001 # Non-public API
                    streams=streams,
        ...
        try:
            self._write_datarheo_message_stream(
    ...
    def _write_datarheo_message_stream(
        self,
        ...
        *,
        ...
        with as_temp_files(
            ...
            try:
                ...
                raise exc.DataRheoConnectorWriteError(
