...
MCP primitives registered by the `cloud` module of the `datarheo-mcp` server: **40** tool(s), **0** prompt(s), **0** resource(s).
...
<a id="check_datarheo_cloud_workspace"></a>

### check_datarheo_cloud_workspace
...
<a id="get_default_cloud_context"></a>
...
| Name | Type | Required | Default | Description |
| --- | --- | --- | --- | --- |
| `name_contains` | `string \| null` | no | `null` | Optional case-insensitive substring to filter organization names. |
| `limit` | `integer \| null` | no | `null` | Optional maximum number of organizations to return (default: 100). |
...
| `workspace_id` | `string \| null` | no | `null` | Workspace ID. Hosted MCP connections pass it via the `X-DataRheo-Workspace-Id` header; local or stdio connections use the `DATARHEO_CLOUD_WORKSPACE_ID` environment variable. |
| `manifest_yaml` | `string \| string \| null` | no | `null` | The Low-code CDK manifest as a YAML string or file path. Required for YAML connectors. |
| `unique` | `boolean` | no | `true` | Whether to require a unique name. |
...
| `manifest_yaml` | `string \| string \| null` | no | `null` | New manifest as YAML string or file path. Optional; omit to update only testing values. |
| `workspace_id` | `string \| null` | no | `null` | Workspace ID. Hosted MCP connections pass it via the `X-DataRheo-Workspace-Id` header; local or stdio connections use the `DATARHEO_CLOUD_WORKSPACE_ID` environment variable. |
